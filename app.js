...
function checkWin() {
    ...
    if (letter.length === show.length) { //Check if the length of the 2 variable are the same. If they are, display the win overlay
        ...
        overlay.innerHTML = `Congratulations! The quote was "${phraseString}." Refresh the browser to play again`
        ...
        overlay.innerHTML = `Sorry! The quote was "${phraseString}." Refresh the browser to play again`; //Change the headline text of the start overlay to show a person lost
        overlay.style.display = 'flex'; //Change the display property of the overlay to 'flex'
    }
